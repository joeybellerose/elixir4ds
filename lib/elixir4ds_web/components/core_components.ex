defmodule Elixir4dsWeb.CoreComponents do
  @moduledoc """
    ...
    <div id={@id} phx-mounted={@show && show_modal(@id)} class="relative z-50 hidden">
      ...
      >
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-2 lg:py-8">
            <.focus_wrap
              id={"#{@id}-container"}
  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "text-sm font-semibold leading-6 text-center",
        @class
      ]}
      {@rest}
    >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Elixir4dsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Elixir4dsWeb.Gettext, "errors", msg, opts)
    end
  end
